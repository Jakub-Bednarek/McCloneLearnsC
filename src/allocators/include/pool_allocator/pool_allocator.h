...
typedef struct pool_allocator_t pool_allocator_t;
typedef void* element_t;

typedef enum {
    MALLOC_ERROR,
    POOL_ALLOCATOR_OK
} pool_allocator_error_t;

extern pool_allocator_error_t pool_allocator_alloc(pool_allocator_t** pool_allocator, size_t element_size, size_t number_of_elements);
